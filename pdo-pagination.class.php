...
class PDO_Pagination {
    ...
    { 
        ...
        if($this->getTotalOfResults() > 0) {         
            $devuelve_html .= '<ul class="pagination pagination-sm no-margin pull-right">'; 
            if ( $current_page > 1 ) { 
                $devuelve_html .= "<li><a href=\"?" . $paginator . "=1"  
                        . $query_string 
                        . "\" class=\"first\"><span>&lsaquo;</span></a></li>"; 
                $previous = $current_page - 1; 
                $devuelve_html .= "<li><a href=\"?" . $paginator . "=" 
                        . $previous . $query_string 
                        . "\" class=\"previous\"><span>&laquo;</span></a></li>"; 
            } 
            ...
            for ( 
                ...
                if ( ( $x > 0 ) && ( $x <= $total_of_pages ) ) { 
                    if ( $x == $current_page ) { 
                        $devuelve_html .= "<li><span class=\"current\">$x</span></li>"; 
                    } else { 
                        $devuelve_html .= "<li><a href=\"?" . $paginator . "=" . $x 
